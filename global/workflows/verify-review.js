...
const DIMENSIONS = [
  ...
  },
  {
    ...
    prompt: [
      ...
      ``,
      `Before flagging anything, read ~/.claude/ai-flow/protocols/criteria.md. A Verifiable Criterion recorded observed: read (or a gap cause recorded against one) has no oracle by design and is accepted as-is — never raise it as a coverage finding, however it reads in the spec.`,
      ``,
