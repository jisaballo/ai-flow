...
this row, and the two moves that run at **every** close — the distribution and the publish. A linked checkout never writes it — the ledger stays with the coordinator, and a row
